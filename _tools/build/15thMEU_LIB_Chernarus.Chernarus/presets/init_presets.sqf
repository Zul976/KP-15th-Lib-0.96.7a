...
switch (KP_liberation_preset_opfor) do {
	...
	case 21: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\3cb_cwlate.sqf";};
    case 22: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\3cb_takistan.sqf";};
